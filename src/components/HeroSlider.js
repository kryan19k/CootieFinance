    ...
    <section id="home">
      <div className="container">
        ...
        <div className="fn_cs_desc">
          <p>
          Lil Cooties represent a collection of 8,888 NFts categorized
              by level of rarity and generated with hundreds of elements. Lil Cooties are stored as ERC-721 tokens on the Flare Network
              and hosted on IPFS.
          </p>
          <a
            href="https://sparklesnft.com/collection/flare/0x1ab19146ec7ea9fc8156c6629cc73d7b0f56922b/"
            className="metaportal_fn_button"
            target="_blank"
            rel="noreferrer"
          >
            <span>Mint a LilCootie</span>
          </a>
        </div>
        {/* !Description */}
      </div>
